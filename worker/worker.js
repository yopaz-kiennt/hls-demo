...
async function step2(page, jobId) {
  ...
  try {
    ...
    await page.waitForSelector("#applicationDetails\\.personalDetails_dobYear");
    ...
    await page.waitForSelector("#applicationDetails\\.personalDetails_dobDay");
    await page.select("#applicationDetails\\.personalDetails_dobDay", "16");
    await sleep(300);

    await page.waitForSelector("#applicationDetails\\.personalDetails_gender");
